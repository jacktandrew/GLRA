...
var zzAdTagId = '900966_'+zzChId+'_'+zzPbId+'_728_90';
document.write("<span id='Zedo-Ad="+zzAdTagId+";Domain=.zedo.com'>");
document.write("</span>")
document.write('<script type="text/javascript">'); 
document.write('ord=Math.random()*10000000000000000;'); 
document.write('document.write(\'<script type="text/javascript" src="http://ad.doubleclick.net/adj/tnews.seattletimes.com/;r=1;sz=728x90ord='+Math.random()+'?;click=http://yads.zedo.com/ads2/c?' + escape(zzLPixie) + escape(zzStr) + escape(zzIdxNw) + escape(zzIdxCh)+ escape(zzIdxPub)+ escape(zzIdxPos)+ escape(zzIdxClk) + escape(ainfo)  + '%3Bk%3D' + zzIdxTrd + ';ord=\' + ord + \'?"><\\\/script>\');;'); 
document.write('<\/script>'); 
document.write('<noscript><a href="http://ad.doubleclick.net/jump/tnews.seattletimes.com/;r=1;sz=728x90;ord=123456789ord='+Math.random()+'??" target="_blank" ><img src="http://ad.doubleclick.net/ad/tnews.seattletimes.com/;r=1;sz=728x90;ord=123456789ord='+Math.random()+'??" border="0" alt="" /></a></noscript>'); 
